...
def load_csv(filepath, target_column=-1, columns_to_ignore=None, has_header=True, categorical_labels=False, n_classes=None):
    """ load_csv.
...
download_dataset(work_directory='./data/')

data, labels = load_csv('./data/titanic_dataset.csv', target_column=0, categorical_labels=True, n_classes=2)
